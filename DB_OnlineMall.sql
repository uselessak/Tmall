...
INSERT INTO `good` (`id`, `name`, `description`, `discount`, `sales`, `sale_money`, `category_id`, `imgs`, `create_time`, `recommend`, `is_delete`) VALUES (11, '山竹水果', '水果山竹，水果之王', 1.00, 6, 59.94, 41, '/file/86e42e4d-8bd9-4257-8c5c-f3ba04f582ce.jpg', '2023-11-12 17:16:15.502456', 1, 0);
...
CREATE TABLE `message` (
  ...
  `user_id` bigint DEFAULT NULL COMMENT '用户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='留言表';

-- ----------------------------
-- Records of message
-- ----------------------------
BEGIN;
INSERT INTO `message` (`id`, `title`, `content`, `time`, `good_id`, `score`, `user_id`) VALUES (70, '', '好可爱', '2024-07-27', 12, 2, 5);
INSERT INTO `message` (`id`, `title`, `content`, `time`, `good_id`, `score`, `user_id`) VALUES (71, '', '很好吃呀', '2024-07-28', 11, 5, 2);
INSERT INTO `message` (`id`, `title`, `content`, `time`, `good_id`, `score`, `user_id`) VALUES (72, '', '非常棒', '2024-07-28', 11, 3, 2);
INSERT INTO `message` (`id`, `title`, `content`, `time`, `good_id`, `score`, `user_id`) VALUES (73, '', '喜欢', '2024-07-28', 10, 5, 5);
COMMIT;
...
CREATE TABLE `sys_file` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='系统文件表';
...
INSERT INTO `sys_file` (`id`, `name`, `type`, `size`, `url`, `is_delete`, `enable`, `md5`) VALUES (35, '吉他.jpg', 'jpg', 16, '/file/7798a81d-daec-446f-ac2d-3f3dab8322f8.jpg', 0, 0, 'bf61f1fc09bd3c587057560827279aab');
INSERT INTO `sys_file` (`id`, `name`, `type`, `size`, `url`, `is_delete`, `enable`, `md5`) VALUES (36, '1.jpg', 'jpg', 191, '/file/86e42e4d-8bd9-4257-8c5c-f3ba04f582ce.jpg', 0, 0, 'f32a75724fd46cc30790b9ad5db5c148');
COMMIT;
...
CREATE TABLE `sys_user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='用户表';
...
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `address`, `avatar_url`, `role`) VALUES (5, 'user2', 'e10adc3949ba59abbe56e057f20f883e', '新用户', NULL, NULL, NULL, NULL, 'user');
COMMIT;
